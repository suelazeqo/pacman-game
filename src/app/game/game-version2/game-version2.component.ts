...
@Component({
  selector: 'app-game-version2',
  templateUrl: './game-version2.component.html',
  styleUrls: ['./game-version2.component.css']
})
export class GameVersion2Component implements OnInit {
